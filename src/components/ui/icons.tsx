...
export const WorkerIcon = ({ className, size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const EmployerIcon = ({ className, size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SupplierIcon = ({ className, size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    className={cn("", className)}
  >
    <path d="M1 3h15l-1 7H3z" />
    <path d="M16 8h5l-1 7H16z" />
    <circle cx="7" cy="20" r="1" />
    <circle cx="17" cy="20" r="1" />
  </svg>
);

export const MaterialIcon = ({ className, size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const FileTextIcon = ({ className, size = 24 }: IconProps) => (
  <svg
    ...
    className={cn("", className)}
  >
    <path d="M14,2 L14,8 L20,8 M14,2 L20,8 L20,20 A2,2 0 0,1 18,22 L6,22 A2,2 0 0,1 4,20 L4,4 A2,2 0 0,1 6,2 L14,2 Z" />
